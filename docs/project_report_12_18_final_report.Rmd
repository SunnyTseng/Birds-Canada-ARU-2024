...
After filtering the dataset to include only the 27 focal species, 788,511 detections were retained. This filtered dataset represents 26 of the 27 focal species, with the White-winged Scoter being the only species not detected in any recordings. The filtered dataset contains 788,511 rows.
...
### Species-specific thresholds (precision = 0.9) & validated dataset
