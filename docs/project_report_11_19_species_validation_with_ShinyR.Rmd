...
-   Listen to each recording and view the spectrogram if needed. Enter "Y" in the validation column if the BirdNET detection is accurate (e.g., Sora is present in the recording). Enter "N" in the validation column if the detection is not accurate (e.g., no Sora was heard). Enter "U" if unsure.
